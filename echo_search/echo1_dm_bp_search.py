...
parser.add_argument('--logdir', type=str, default='echo_bp_15way_a', help='save directory')
parser.add_argument('--seed', type=int, default=20000, help='seed value')
...
parser.add_argument('--tau', type=float, default=50, help='time constant of echo1')
parser.add_argument('--num_dm', type=int, default=5, help='number of dm cells')
parser.add_argument('--num_echo', type=int, default=1000, help='number of echo cells')
...
parser.add_argument('--rho_scale', type=float, default=1.0, help='learning rate for adam')
...
args.save_dir = "{},{},{},{}".format(args.tau,args.tau_dm,args.rho_scale,args.seed)
